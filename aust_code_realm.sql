...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 02, 2024 at 07:32 AM
...
(39, 13, 7, 'C++ (GCC 7.4.0)', '2024-08-02 05:01:50', '2024-08-02 05:01:50', 0, 1532, '#include<bits/stdc++.h>\r\nusing namespace std;\r\n#define M        1000000007\r\n#define INF      1e18+9\r\n#define PI       acos(-1.0)\r\n#define ll       long long int\r\n#define ull      unsigned long long int\r\n#define all(x)   (x).begin(), (x).end()\r\n#define pb       push_back\r\n#define tc         \\\r\n        int tcase,tno; \\\r\n        cin >> tcase;  \\\r\n        for(tno=1;tno<=tcase;tno++)\r\n#define pcn         cout<<\"Case \"<<tno<<\":\"<<endl;\r\n#define ff(i,n)     for(ll i=0;i<n;i++)\r\n\r\n\r\nint main(){\r\n    ios_base:: sync_with_stdio(false);cin.tie(NULL);cout.tie(NULL);\r\n    int n;\r\n    cin>>n;\r\n    vector<int> v(n);\r\n    ff(i,n){\r\n        cin>>v[i];\r\n    }\r\n    cout<<1<<endl;\r\n    return 0;\r\n}', 'Accepted', 100);
...
--
ALTER TABLE `submissions`
  MODIFY `SubmissionID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;
